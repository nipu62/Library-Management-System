        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <a class="btn btn-xs btn-warning" href="<?php echo e(route('updatePlace', $place->id)); ?>">Edit</a>
                    <a class="btn btn-xs btn-danger" href="<?php echo e(route('deletePlace', $place->id)); ?>">Delete</a>
