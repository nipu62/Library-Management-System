                ...
                <div class="panel-body">
                    ...
                    <tr>
                        ...
                        <td><?php echo $book->numberofbooks; ?></td>
                                                    <td>
                            <a class="btn btn-xs btn-warning" href="<?php echo route('userUpdatePlace', $book->_id); ?>">Update</a>
                            <td>
                            <a class="btn btn-xs btn-warning" href="<?php echo route('putUserRequestBook', $book->_id); ?>">Issue</a> </td>
